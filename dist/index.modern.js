...
import { FaFacebookF, FaTwitter, FaLinkedinIn, FaYoutube, FaInstagram, FaPinterestP, FaYelp } from 'react-icons/fa';
import { Link } from 'gatsby';
import { Row, Col, Form, Container } from 'react-bootstrap';
import { IoIosClose } from 'react-icons/io';
import { WMKLink as WMKLink$1 } from 'wmk-lib';
...
var SocialMediaIcon = React.forwardRef(function (_ref, ref) {
...
var SocialMediaIcons = function SocialMediaIcons(_ref) {
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, query.map(function (icon) {
    var title = icon.title,
        url = icon.url,
        target = icon.target;
    var platform = getPlatform(title, platforms);
    return /*#__PURE__*/React.createElement(SocialMediaIcon, {
      platform: platform,
      url: url,
      target: target,
      className: _className,
...
var WMKLink = React.forwardRef(function (_ref, ref) {
  var to = _ref.to,
      id = _ref.id,
      children = _ref.children,
      target = _ref.target,
  ...
  return _target && _target !== "_internal" || _target && _target !== "_link" || mailto || tel ? /*#__PURE__*/React.createElement(Anchor, {
    to: _to,
    mailto: mailto,
    tel: tel,
    target: target,
...
var SearchSliderDrawer = function SearchSliderDrawer(_ref) {
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: "close"
  }, /*#__PURE__*/React.createElement(Close, null))), /*#__PURE__*/React.createElement(Col, {
    style: {
      display: "flex",
  ...
  }) : searchResults && !searchResults.length && searchKey !== "" ? /*#__PURE__*/React.createElement(Col, null, /*#__PURE__*/React.createElement("em", null, "No results matching ", /*#__PURE__*/React.createElement("strong", null, searchKey), "."), /*#__PURE__*/React.createElement("p", null, /*#__PURE__*/React.createElement("sub", null, "Please try another search."))) : null)))));
};
...
SearchSliderDrawer.defaultProps = {
  Result: function Result(_ref2) {
    ...
    return /*#__PURE__*/React.createElement(WMKLink$1, {
      to: result.slug
    }, result.title);
  },
  Close: function Close() {
    return /*#__PURE__*/React.createElement(IoIosClose, null);
  },
...
var Copyright = React.forwardRef(function (_ref, ref) {
...
var Footer = React.forwardRef(function (_ref, ref) {
  var children = _ref.children,
      className = _ref.className,
      id = _ref.id;
...
var MainLayout = function MainLayout(_ref) {
  ...
  }, /*#__PURE__*/React.createElement(HeaderJSX, null), /*#__PURE__*/React.createElement("main", {
    className: wmkClass("main", "layout", className)
  }, children), /*#__PURE__*/React.createElement(FlexSpacer, null), /*#__PURE__*/React.createElement(FooterJSX, null));
};
...
MainLayout.defaultProps = {
  Header: function Header() {
    return /*#__PURE__*/React.createElement("div", null, "Pass Header JSX");
  },
  Footer: function Footer() {
    return /*#__PURE__*/React.createElement("div", null, "Pass Footer JSX");
  }
};
...
var Sticky = function Sticky(_ref) {
  ...
  }, !isTriggered ? Alert : null, /*#__PURE__*/React.createElement(Header, {
    ref: headerRef
  }, children)), Alert && isTriggered ? /*#__PURE__*/React.createElement("div", {
    style: {
      height: headerRect.y
    }
  }) : null, isTriggered && /*#__PURE__*/React.createElement("div", {
    style: {
...
var ListItemColumn = function ListItemColumn(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Row, {
    ...
    return /*#__PURE__*/React.createElement(JSX, {
      key: li + i,
      li: li
    });
  }) : null);
...
ListItemColumn.defaultProps = {
  JSX: function JSX(_ref2) {
    var li = _ref2.li;
    return /*#__PURE__*/React.createElement(Col, null, console.log(li), " List Item Data");
  }
};
...
var ListItemColumns = function ListItemColumns(_ref) {
  ...
  return columns && columns.length ? /*#__PURE__*/React.createElement(Row, {
    ...
    return /*#__PURE__*/React.createElement(Col, {
      ...
      md: 6,
      lg: 4
    }, /*#__PURE__*/React.createElement(ListItemColumn, {
      list: col,
      JSX: JSX
    }));
  })) : null;
...
var Video = function Video(_ref) {
  ...
  }), (!readyState || readyState < 4) && !hasLoaded ? /*#__PURE__*/React.createElement(Loader, null) : null, /*#__PURE__*/React.createElement(Player, {
    ref: playerRef,
    poster: poster,
    preload: "auto",
    muted: true,
...
var LightBoxImage = function LightBoxImage(_ref) {
  ...
  }, caption)), isExpanded ? /*#__PURE__*/React.createElement(Container, {
    fluid: true,
    style: {
      position: "fixed",
      top: 0,
  ...
  }, /*#__PURE__*/React.createElement(IoIosClose, null))), /*#__PURE__*/React.createElement(Col, {
    style: {
      display: "flex",
      justifyContent: "center",
      WebkitFlex: "initial",
  ...
  })), caption && /*#__PURE__*/React.createElement(Col, {
    style: {
      display: "flex",
      justifyContent: "center",
      WebkitFlex: "initial"
...
var MenuItems = function MenuItems(_ref) {
  ...
  return /*#__PURE__*/React.createElement(Row, {
    className: "flex-column"
  }, /*#__PURE__*/React.createElement(Header, null, header), menus && menus.map(function (item, i) {
...
MenuItems.defaultProps = {
  Header: function Header(_ref2) {
    ...
    return /*#__PURE__*/React.createElement(Col, null, children);
  },
  Menu: function Menu(_ref3) {
    var to = _ref3.to,
        target = _ref3.target,
        children = _ref3.children;
    return /*#__PURE__*/React.createElement(Col, null, /*#__PURE__*/React.createElement(WMKLink, {
      to: to,
      target: target
    }, children));
  },
...
var ContentfulLogo = function ContentfulLogo(_ref) {
  ...
  switch (true) {
    ...
    default:
      JSX = function JSX() {
        return /*#__PURE__*/React.createElement("div", null, "Contentful Image Error");
      };

  }

  return target === "internal" ? /*#__PURE__*/React.createElement(WMKLink, {
    to: to
  }, /*#__PURE__*/React.createElement(JSX, {
    src: url,
    alt: alt,
    fixed: isFixed,
    fluid: isFluid,
    className: className,
    id: id
  })) : /*#__PURE__*/React.createElement(WMKLink, {
    to: to,
    target: target
  }, /*#__PURE__*/React.createElement(JSX, {
    src: url,
...
export { Anchor, ContentfulLogo, Copyright, FlexSpacer, Footer, Header, LightBoxImage, ListItemColumns, MainLayout, MediaQueries, MenuItems, SEO, Search, SearchSliderDrawer$1 as SearchSliderDrawer, SearchSliderOpen$1 as SearchSliderOpen, SocialMediaIcons, Sticky, UrlPaths, Video, WMKLink, generateGraph };
